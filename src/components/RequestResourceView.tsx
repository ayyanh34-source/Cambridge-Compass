...
import { BookOpen, Library, Send, CheckCircle2, Loader2 } from 'lucide-react';
          ...
          <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
            ...
            <fieldset className="space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <label
                  ...
                  className={`relative flex cursor-pointer rounded-xl border p-4 transition-all ${subjectType === 'existing'
                ...
                <label
                  ...
                  className={`relative flex cursor-pointer rounded-xl border p-4 transition-all ${subjectType === 'new'
                    ? 'border-[#1A1A1A] bg-[#FAF7F0] shadow-xs'
                    : 'border-[#EBE8E1] bg-white hover:bg-[#FAF7F0]'
                    }`}
                >
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <button
                    ...
                    className={`text-[11px] font-mono uppercase tracking-wider px-3.5 py-2 rounded-full border transition-all ${categoryTag === tag
            ...
            <div className="pt-4 flex flex-col sm:flex-row items-center justify-between border-t border-[#EBE8E1] gap-4">
              ...
              <button
                ...
                className={`w-full sm:w-auto inline-flex items-center justify-center gap-2 h-12 px-8 text-xs font-mono uppercase tracking-[0.18em] rounded-full transition-all duration-200 shadow-sm active:scale-[0.98] ${submitSuccess
